...
# =============================================================================
# This file defines variables for the development environment.
# Default values are optimized for development use.
# =============================================================================
...
variable "ses_enable_domain_verification" {
  description = "Enable domain verification (set to false until DNS records are configured)"
  type        = bool
  default     = false
}
...
variable "ses_email_identities" {
  ...
  type        = list(string)
  default = [
    "dev-notifications@mashrook.sa",
    "dev-invoices@mashrook.sa"
  ]
}
...
variable "ses_bounce_rate_threshold" {
  description = "Bounce rate percentage that triggers an alarm"
  type        = number
  default     = 5
}

variable "ses_complaint_rate_threshold" {
  description = "Complaint rate percentage that triggers an alarm"
  type        = number
  default     = 0.1
}
