...
# =============================================================================
# This file configures the notification infrastructure for the development
...
terraform {
  ...
  backend "s3" {
    ...
    key            = "sns-notifications/dev/terraform.tfstate"
    region         = "me-south-1"
...
module "sns_notifications" {
  ...
  # SMS configuration - lower limits for dev
  monthly_spend_limit = var.monthly_spend_limit
  default_sms_type    = var.default_sms_type
  default_sender_id   = var.default_sender_id

  # Monitoring - lower thresholds for dev to catch issues early
  ...
  # Logging - shorter retention for dev to reduce costs
