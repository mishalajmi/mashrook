...
@DisplayName("BracketEvaluationService Tests")
class BracketEvaluationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        bracketEvaluationService = new BracketEvaluationService(discountBracketRepository, pledgeRepository);
    ...
    class CalculateTotalPledged {
        ...
        void shouldReturnZeroWhenNoPledgesExist() {
            ...
            int total = bracketEvaluationService.calculateTotalPledged(campaignId);
    ...
    class GetCurrentBracket {
        ...
        void shouldReturnEmptyWhenNoBracketsExist() {
            ...
            Optional<DiscountBracketEntity> bracket = bracketEvaluationService.getCurrentBracket(campaignId);
        ...
        void shouldReturnBracketWhereQuantityIsWithinRange() {
            ...
            Optional<DiscountBracketEntity> result = bracketEvaluationService.getCurrentBracket(campaignId);
    ...
    class GetNextBracket {
        ...
        void shouldReturnEmptyWhenNoBracketsExist() {
            ...
            Optional<DiscountBracketEntity> result = bracketEvaluationService.getNextBracket(campaignId);
    ...
    class GetUnitPriceForQuantity {
        ...
        void shouldReturnEmptyWhenNoBracketsExist() {
            ...
            Optional<BigDecimal> result = bracketEvaluationService.getUnitPriceForQuantity(campaignId, 50);
        ...
        void shouldReturnPriceForFirstBracket() {
            ...
            Optional<BigDecimal> result = bracketEvaluationService.getUnitPriceForQuantity(campaignId, 25);
        ...
        void shouldReturnPriceForSecondBracket() {
            ...
            Optional<BigDecimal> result = bracketEvaluationService.getUnitPriceForQuantity(campaignId, 75);
        ...
        void shouldReturnPriceForUnlimitedBracket() {
            ...
            Optional<BigDecimal> result = bracketEvaluationService.getUnitPriceForQuantity(campaignId, 500);
        ...
        void shouldReturnPriceAtMaxQuantityBoundary() {
            ...
            Optional<BigDecimal> result = bracketEvaluationService.getUnitPriceForQuantity(campaignId, 49);
        ...
        void shouldReturnFirstBracketPriceForZeroQuantity() {
            ...
            Optional<BigDecimal> result = bracketEvaluationService.getUnitPriceForQuantity(campaignId, 0);
